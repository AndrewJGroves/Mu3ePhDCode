...
void runner2(TString input, TString path, TString output,  int VertexType = -1, float Weight = -1) {

  std::cout<<"Weight Sum "<<Weight<<std::endl;
  std::cout<<"Vertex Type "<<VertexType<<std::endl;
