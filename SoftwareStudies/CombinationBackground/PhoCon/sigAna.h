...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<double>  *true_cx1;
   vector<double>  *true_cy1;
   vector<double>  *true_cz1;
   vector<double>  *r1;
   ...
   vector<double>  *true_cx2;
   vector<double>  *true_cy2;
   vector<double>  *true_cz2;
   vector<double>  *r2;
   ...
   vector<double>  *true_cx3;
   vector<double>  *true_cy3;
   vector<double>  *true_cz3;
   vector<double>  *r3;
  ...
  vector<double>  *t0_si1;
  vector<double>  *t0_si2;
  vector<double>  *t0_si3;
  vector<double>  *t0_fb1;
  vector<double>  *t0_fb2;
  vector<double>  *t0_fb3;
  vector<double>  *t0_tl1;
  vector<double>  *t0_tl2;
  vector<double>  *t0_tl3;
  vector<double>  *t0_mc1;
  vector<double>  *t0_mc2;
  vector<double>  *t0_mc3;
  vector<double>  *tv_1;
  vector<double>  *tv_2;
  vector<double>  *tv_3;
  vector<double>  *tv_mc1;
  vector<double>  *tv_mc2;
  vector<double>  *tv_mc3;
 ...
 private:
   ...
   bool hasTrueVertexInAcceptance();//!
   bool trackComparison(TVector3 p1,TVector3 p2,double r1,double r2);//!
   bool checkVertexConsistency(int n1);//!
   bool hasPhoMic(int p);//!
   std::vector<int> getTrackType(int nv);//!
   int getNTracksCommon(int a[],int b[]);//!
   bool trackComparison2(TVector3 v1,TVector3 v2,double r1,double r2);//!
   int VtxTrackComparison(int n1,int n2);//!
   double VtxDistance(int n1,int n2);//!
   int getGoodTrack(int nv);//!
...
void sigAna::Init()   // (TTree *tree)
{
  ...
  tv_mc3 = 0;
   ...
   fChain->SetBranchAddress("true_cx1", &true_cx1, &b_true_cx1);
   fChain->SetBranchAddress("true_cy1", &true_cy1, &b_true_cy1);
   fChain->SetBranchAddress("true_cz1", &true_cz1, &b_true_cz1);
   ...
   fChain->SetBranchAddress("true_cx2", &true_cx2, &b_true_cx2);
   fChain->SetBranchAddress("true_cy2", &true_cy2, &b_true_cy2);
   fChain->SetBranchAddress("true_cz2", &true_cz2, &b_true_cz2);
   ...
   fChain->SetBranchAddress("true_cx3", &true_cx3, &b_true_cx3);
   fChain->SetBranchAddress("true_cy3", &true_cy3, &b_true_cy3);
   fChain->SetBranchAddress("true_cz3", &true_cz3, &b_true_cz3);
  ...
  fChain->SetBranchAddress("tv_1", &tv_1, &b_tv_1);
  fChain->SetBranchAddress("tv_2", &tv_2, &b_tv_2);
  fChain->SetBranchAddress("tv_3", &tv_3, &b_tv_3);
  fChain->SetBranchAddress("tv_mc1", &tv_mc1, &b_tv_mc1);
  fChain->SetBranchAddress("tv_mc2", &tv_mc2, &b_tv_mc2);
  fChain->SetBranchAddress("tv_mc3", &tv_mc3, &b_tv_mc3);
  fChain->SetBranchAddress("t0_si1", &t0_si1, &b_t0_si1);
  fChain->SetBranchAddress("t0_si2", &t0_si2, &b_t0_si2);
  fChain->SetBranchAddress("t0_si3", &t0_si3, &b_t0_si3);
  fChain->SetBranchAddress("t0_tl1", &t0_tl1, &b_t0_tl1);
  fChain->SetBranchAddress("t0_tl2", &t0_tl2, &b_t0_tl2);
  fChain->SetBranchAddress("t0_tl3", &t0_tl3, &b_t0_tl3);
  fChain->SetBranchAddress("t0_fb1", &t0_fb1, &b_t0_fb1);
  fChain->SetBranchAddress("t0_fb2", &t0_fb2, &b_t0_fb2);
  fChain->SetBranchAddress("t0_fb3", &t0_fb3, &b_t0_fb3);
  fChain->SetBranchAddress("t0_mc1", &t0_mc1, &b_t0_mc1);
  fChain->SetBranchAddress("t0_mc2", &t0_mc2, &b_t0_mc2);
  fChain->SetBranchAddress("t0_mc3", &t0_mc3, &b_t0_mc3);
   Notify();
}
